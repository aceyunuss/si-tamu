...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-lg"><b style="font-size:16px;">Visitor Management</b></span>
    </a>
          ...
          <!-- User Account: style can be found in dropdown.less -->
           ...
           <?php
                  if($_SESSION['sekretaris']){
                       $user_l=$_SESSION['sekretaris'];

                  }elseif ($_SESSION['security']) {
                       $user_l=$_SESSION['security'];
                  }

                  elseif ($_SESSION['K3 & HSE Dept']) {
                       $user_l=$_SESSION['K3 & HSE Dept'];
                  }
...
<?php $tgl2 = date('Y'); ?>
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021-<?php echo $tgl2; ?> <?php echo $data1['nama_perusahaan'] ?></a>.</strong> All rights
    reserved.
  </footer>
