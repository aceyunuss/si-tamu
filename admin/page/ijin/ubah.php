  ...
  $jml_tenaga = $_POST ['jml_tenaga'];
    ...
    $potensi = implode($_POST["potensi"], ', ');
 	...
 	if ($simpan) {
 		...
 		$sql = $koneksi->query("update  tb_ijin set nama_perusahaan='$nama_perusahaan', penanggungjawab='$penanggungjawab', jenis_pekerjaan='$jenis_pekerjaan',  jml_tenaga='$jml_tenaga', waktu_pelaksanaan='$waktu_pelaksanaan', potensi_bahaya='$potensi', apd='$apd', daftar_alat='$alat_kerja' where id_ijin='$id'");
